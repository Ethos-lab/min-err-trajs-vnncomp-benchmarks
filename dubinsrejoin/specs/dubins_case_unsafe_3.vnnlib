; Dubins Rejoin property unsafe_3
...
(assert >= X_5 -0.015999999999999993

; Input 6
(assert <= X_6 -0.12986256648048383
(assert >= X_6 -0.1618625664804838

; Input 7
(assert <= X_7 0.494251096914295
(assert >= X_7 0.46225109691429495

; unsafe if command is [13] (spec type disjunct) 
(assert or 
