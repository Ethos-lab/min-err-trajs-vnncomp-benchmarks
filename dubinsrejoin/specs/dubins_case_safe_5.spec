...
; Input 0
(assert <= X_0 0.09231943749537336
(assert >= X_0 0.09031943749537336

; Input 1
(assert <= X_1 -0.3180010408620675
(assert >= X_1 -0.3200010408620675

; Input 2
(assert <= X_2 -0.4045917115119976
(assert >= X_2 -0.4065917115119976

; Input 3
(assert <= X_3 -0.2625095100472383
(assert >= X_3 -0.2645095100472383

; Input 4
(assert <= X_4 0.5009999999999999
(assert >= X_4 0.49899999999999994

; Input 5
(assert <= X_5 0.0010000000000000356
(assert >= X_5 -0.0009999999999999645

; Input 6
(assert <= X_6 0.20139849912315624
(assert >= X_6 0.19939849912315624

; Input 7
(assert <= X_7 -0.45708344387151373
(assert >= X_7 -0.45908344387151373
